...
#     
#     install_spec =
#       case MLI.parse_args(args, opts) do
#         {:error, message} -> Mix.raise message <> "\n" <> usage()
#         install_spec      -> install_spec
#       end
# 
#     IO.inspect ["INSTALL_SPEC", install_spec]
#     case check_install_spec(install_spec, opts) do
#       :ok               -> :noop
#       {:error, message} -> Mix.raise message <> "\n" <> usage()
#     end
...
#         IO.puts "inspect #{install_spec}"
#         MLI.install({__MODULE__, target}, [src], switches)
# 
#       :project ->
#         dir = System.cwd()
#         
#         name = Mix.Local.name_for(target, Mix.Project.config)
#         case Cache.install_from_local_tree(name, dir) do
#           { :error, reason } ->
#             Mix.raise(reason)
#           :ok ->
#             :ok
...
# 
#   defp usage() do
#     "\nuse `mix help template.install` for more information"
#   end
#   
#     # defp usage() do
#     #   IO.puts "Usage:\n"
